...
import django
sys.path.insert(0, os.path.abspath('..'))
os.environ['DJANGO_SETTINGS_MODULE'] = 'ads_on_the_run.settings'
django.setup()
...
htmlhelp_basename = 'ads_on_the_rundoc'
...
man_pages = [
    (master_doc, 'ads_on_the_run', 'ads_on_the_run Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ads_on_the_run', 'ads_on_the_run Documentation',
     author, 'ads_on_the_run', 'One line description of project.',
     'Miscellaneous'),
]
